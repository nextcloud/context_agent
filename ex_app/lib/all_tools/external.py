...
def get_tools(nc: Nextcloud):
	...
	@tool
	@safe_tool
	def get_public_transport_route_for_coordinates(origin_lat: str, origin_lon: str, destination_lat: str, destination_lon: str, routes: int, departure_time: Optional[str]) -> dict[str, typing.Any]:
		"""

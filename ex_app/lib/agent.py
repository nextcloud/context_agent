...
Intuit the language the user is using (there is not tool for this, you will need to guess). Reply in the language intuited. Do not output the language you intuited.
